...
const StepsSection = () => {
    return (
        <div>
            ...
            <h2 className="md:text-4xl text-3xl font-bold text-center mb-14 text-r-text">Build your job-winning resume<br />steps by steps</h2>
                    ...
                    <div className="p-8 rounded-xl max-w-3xl mx-auto">
                        <div className="space-y-4">
                            <div className="flex items-center gap-4 p-4">
                                <div className="">
                                    <FiArrowRightCircle className="w-5 h-5 text-r-secondary" />
                                </div>
                                <div>
                                    <h3 className="text-lg font-semibold text-r-text">Choose a Template</h3>
                            ...
                            <div className="flex items-center gap-4 p-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-r-text">Customize Your Information</h3>
                            ...
                            <div className="flex items-center gap-4 p-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-r-text">Enhance with AI Suggestions</h3>
                            ...
                            <div className="flex items-center gap-4 p-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-r-text">Preview & Edit</h3>
                            ...
                            <div className="flex items-center gap-4 p-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold text-r-text">Download & Share</h3>

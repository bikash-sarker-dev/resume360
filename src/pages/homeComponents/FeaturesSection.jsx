            ...
            <div className="max-w-6xl mx-auto py-16 px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-md:max-w-md mx-auto text-center">
                    <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                        <div className="p-8">
                            <div className="mb-5 flex justify-center"><BiCustomize className="size-10 text-r-accent"></BiCustomize></div>
                    ...
                    <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                        <div className="p-8">
                            <div className="mb-5 flex justify-center"><LuSquareDashedMousePointer className="size-10 text-r-accent"></LuSquareDashedMousePointer></div>
                    ...
                    <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                        <div className="p-8">
                            <div className="mb-5 flex justify-center"><VscPreview className="size-10 text-r-accent"></VscPreview></div>
                    ...
                    <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                        <div className="p-8">
                            <div className="mb-5 flex justify-center"><BsRobot className="size-10 text-r-accent"></BsRobot></div>
                    ...
                    <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                        <div className="p-8">
                            <div className="mb-5 flex justify-center"><FaRegFileAlt className="size-10 text-r-accent"></FaRegFileAlt></div>
                    ...
                    <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
                        <div className="p-8">
                            <div className="mb-5 flex justify-center"><PiReadCvLogo className="size-10 text-r-accent"></PiReadCvLogo></div>

        ...
        <div className="md:col-span-2">
          ...
          <div className="mt-6 p-6 rounded-xl bg-opacity-30 backdrop-blur-xl border border-[#588568] shadow-lg">
            ...
            <p className="flex items-center text-r-text mt-2">
              <FiPhone className="mr-2 text-r-primary" /> {profile?.phone}
            </p>
            <p className="flex items-center text-r-text mt-2">
              <FiMail className="mr-2 text-r-primary" /> {profile?.email || user?.email}
            </p>
            <a
              href={profile?.website}
              className="border-b border-[#588568] text-r-primary"
            >
              my protfolio
            </a>
          </div>

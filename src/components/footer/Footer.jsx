    ...
    <footer className="relative   bg-r-info  text-r-text pt-16 pb-8 px-8 md:px-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4  text-center md:text-left">
        ...
        <div className="text-3xl font-serif  flex flex-col   min-w-full sm:min-w-[200px] lg:min-w-[280px] xl:min-w-[350px]">
          ...
          <p className="text-base mt-3">Create, design, and manage your professional resume with ease. Our virtual resume builder helps you showcase your skills, experience, and education in a sleek and user-friendly format.</p>
        </div>

        <div className="flex flex-col   text-left items-center">
          <h3 className="text-xl ml-[-20px] sm:mt-0 mt-8 font-semibold">Menu</h3>
        ...
        <div className="flex flex-col  items-center text-left">
          <h3 className="text-xl  ml-[-50px] mt-9 sm:mt-0 font-semibold">Information</h3>
          <ul className="mt-3 grid grid-cols-1 space-y-2">
            <Link to="/about">
              <a className="hover:text-r-accent cursor-pointer ">About Us</a>
            </Link>
            <Link to="/terms">
              <a className="hover:text-r-accent cursor-pointer">Terms & Conditions</a>
            </Link>
            <Link to="/privacy-policy">
              <a className="hover:text-r-accent cursor-pointer">Privacy Policy</a>
            </Link>
            <Link to="/faq">

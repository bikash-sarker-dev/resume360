            ...
            <div className="card-body">
              ...
              <div className="mt-6 ">
                <Link
                  ...
                  class="relative inline-flex items-center justify-center px-10 py-4 overflow-hidden  font-bold  text-r-text bg-r-background rounded- group slide-up slide-up-btn"
                >

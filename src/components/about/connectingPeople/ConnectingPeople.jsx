...
const ConnectingPeople = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-4  md:p-12 lg:p-14">
    
      <div className="md:col-span-6 lg:col-span-7 text-center md:text-left">
        <h1 className="text-3xl md:text-5xl font-bold w-1/2">
          We're changing <br className="hidden md:block" /> the way people
          connect
        </h1>
        <p className="py-4 md:py-6 text-gray-500 text-sm md:text-base w-1/2">

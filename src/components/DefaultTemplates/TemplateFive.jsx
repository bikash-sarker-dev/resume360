...
const TemplateFive = () => {
  return (
    <div className="my-20">
      <div className="container mx-auto pb-8 pt-24 lg:pb-12  bg-white">
        {/* Header Section */}
        <div>
          <div className="bg-white shadow-lg rounded-lg p-16">
            ...
            <section>
              ...
              <p>
                Experienced Software Development Engineer in Test with expertise
                in full-stack development, Agile methodologies, and cloud
                computing.
              </p>
            </section>
            <hr className="my-4" />
            ...
            <section>
              ...
              <div className="">
                ...
                <ul className="list-disc pl-5">
                  <li>
                    Tested and validated fixed income clearing applications for
                    FICC risk, ensuring seamless user experiences on the client
                    portal.
                  </li>
                  <li>
                    Collaborated with cross-functional teams to align on best
                    practices and deliver high-quality solutions for FRM
                    internal and external clients.
                  </li>
                  <li>
                    Executed comprehensive test plans to ensure the reliability
                    and performance of clearing applications, contributing to
            ...
            <section className="mt-6">
              ...
              <div className="mt-4">
                ...
                <ul className="list-disc pl-5">
                  <li>
                    Elevated student mastery of Java fundamentals, encompassing
                    OOP, data structures, and algorithms, via interactive
                    sessions and exercises.
                  </li>
                  <li>
                    Created and executed over 20 lessons and activities tailored
                    to augment students’ acquisition of foundational and
              ...
              <div className="mt-4">
                ...
                <ul className="list-disc pl-5">
                  <li>
                    Developed an internal learning platform using React.js, CSS,
                    and HTML, boosting worker productivity.
                  </li>
                  <li>
            ...
            <section>
              ...
              <ul>
                <li>
                  <strong>Georgia Institute of Technology</strong> - MS in
                  Computer Science
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc pl-5">
                <li>
                  <strong>Full-stack Skincare Website:</strong> Built with
                  React.js, Express.js, and MongoDB for skincare recommendations
                  and specialist appointments.
                </li>
                <li>
                  <strong>Matrimony Website:</strong> A matchmaking platform
                  using React, Express.js, and MongoDB, featuring user
                  dashboards and premium services.
                </li>
                <li>

...
const TemplateOne = () => {
  return <div className="container pb-8 pt-28 lg:pb-12">
    <div className="bg-white p-16">
      ...
      <p className="mb-2"><i className="fa-solid fa-location-dot mr-2"></i>Dhaka, Bangladesh | <i class="fa-solid fa-envelope mr-2"></i>denial123@gmail.com | <i className="fa-solid fa-phone mr-2"></i>+8801523892111</p>
      <div className="text-2xl">
         <a href="https://www.linkedin.com/in/sadia-afrin-597515301/"><i className="fa-brands fa-linkedin mr-10"></i></a>
         <a href="https://github.com/Sadia0920"><i className="fa-brands fa-github mr-10"></i></a>
         <a href="https://www.facebook.com/sadia.afrin.khan.52"><i className="fa-brands fa-square-facebook"></i></a>
        </div>

      {/* Summary section */}
      <section className="mt-6">
      <h3 className="text-lg font-bold bg-gray-300 px-6 py-2 rounded-full mb-2">SUMMARY</h3>
      <p>UX Designer with a focus on devivering impactful results, eager to trackle dynamic challenges and apply creativity to craft intutive user experiences. Demonstrated profiency in project management, user-centric problem-solving, and seamless collaboration across teams skilled in leveraging state-of-the-art tools and methosologies to streaming processes and elevate user satisfaction.</p>
      </section>
      ...
      <h3 className="text-lg font-bold bg-gray-300 px-6 py-2 rounded-full mb-2">EXPERIENCE</h3>
        ...
        <ul  className="list-inside list-disc">
         <li>Led development of an advance automation system, achieving a 15% increase in operational efficiency.</li>
         <li>Steamlined manufacturing processes, reducung production costs by 10%.</li>
         <li>Implemented preventive maintenance strategies, resuting in a 20% decrease in equipment downtime.</li>
        </ul>
        {/* experience - 2 */}
        ...
        <ul  className="list-inside list-disc">
         <li>Design and optimised a robotic control system, realizing a 12% performance improvement.</li>
         <li>Coordinated texting and validation, ensuring compliance with industry standards.</li>
      ...
      <h3 className="text-lg font-bold bg-gray-300 px-6 py-2 rounded-full mb-2">PROJECTS</h3>
        ...
        <div className="flex"><p className="font-bold mr-2">Role: </p><p> UX Designer</p></div>
        <div className="flex"><p className="font-bold mr-2">Tools: </p><p>Figma, Adobe XD, Sketch, Usability Testing</p></div>
        ...
        <div className="grid grid-cols-3">
          <a className="underline text-blue-500" href="http://localhost:5173/templateOne">Live Link</a>
        <a className="underline text-blue-500" href="http://localhost:5173/templateOne">Client Github Link</a>
        <a className="underline text-blue-500" href="http://localhost:5173/templateOne">Server Github Link</a>
        </div>
         {/* project - 2 */}
         <p className="font-bold mt-4">2. Task Management App</p>
        <div className="flex"><p className="font-bold mr-2">Role: </p><p> UX Designer</p></div>
        <div className="flex"><p className="font-bold mr-2">Tools: </p><p>Figma, Adobe XD, User Interviews, Wireframing</p></div>
        <p className="font-bold">Key Contributions:</p>
        <ul  className="list-inside list-disc">
